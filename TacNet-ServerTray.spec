...
a = Analysis(
    ['C:\\Users\\johnn\\Desktop\\Archive\\mil_radiov3\\mil_radiov3\\radio_server_tray.py'],
    pathex=[],
    binaries=[],
    ...
    hiddenimports=['cryptography', 'scipy.signal', 'numpy', 'pystray', 'pystray._win32', 'PIL', 'PIL.Image', 'PIL.ImageDraw'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
    excludes=[],
